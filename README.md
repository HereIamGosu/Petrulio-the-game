...
- 🔥 Берегись пустоты, которая находится внизу — падение туда означает конец игры!

Цель игры — собрать как можно больше монет и уничтожить врагов, при этом избегая пустоты и не давая врагам свести здоровье Petrulio к нулю.
...
Собранная версия игры для Windows доступна в разделе [релизы](https://github.com/HereIamGosu/Petrulio-the-game/releases). Вы можете скачать готовую .exe сборку и сразу начать играть.
